        ...
        <div className="flex items-center gap-3 w-full">
          <div className="group relative w-7 h-7 flex items-center justify-center rounded-lg bg-black dark:bg-transparent hover:bg-black dark:hover:bg-black transition-all duration-300 cursor-pointer overflow-visible shadow-sm shrink-0">
            <img
              ...
              alt="Logo"
              className="w-24 h-24 max-w-none object-contain absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transition-all duration-300 opacity-100 group-hover:opacity-0 scale-100 group-hover:scale-75"
            />
            <img
              src="/assets/kaios_inverse_icon.png"
              alt="Logo"
              className="w-36 h-36 max-w-none object-contain absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transition-all duration-300 opacity-0 group-hover:opacity-100 scale-75 group-hover:scale-100"
            />
          </div>
